  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 fixed top-0 right-0 left-0 lg:left-64 z-10 flex items-center justify-between px-4 sm:px-6">
      ...
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div className="relative flex-1 sm:block max-w-md mr-2">
      ...
      <div className="flex items-center gap-1 sm:gap-4">
        ...
        <button className="flex items-center gap-2 bg-amber-500 hover:bg-amber-600 text-black px-2 sm:px-4 py-2 rounded-lg font-medium text-sm transition">
          <Plus size={18} />
