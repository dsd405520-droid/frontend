          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-100 text-gray-400 text-xs">
                <th className="p-4 font-medium">ຊື່ສາຂາ (_id)</th>
                <th className="p-4 font-medium">ທີ່ຕັ້ງ</th>
                <th className="p-4 font-medium">ຈຳນວນພະແນກ</th>
              ...
              {branches.length > 0 ? (
                branches.map((item) => (
                  <tr key={item._id} className="hover:bg-gray-50">
                    ...
                    <td className="p-4">{item.departmentsCount || 0} ພະແນກ</td>
                ...
                <tr>
                  <td colSpan="4" className="py-12 text-center text-sm text-gray-400">
                    ຍັງບໍ່ມີຂໍ້ມູນສາຂາ (ພ້ອມເຊື່ອມຕໍ່ NestJS Backend)
                  </td>
                </tr>
              )}
            </tbody>
